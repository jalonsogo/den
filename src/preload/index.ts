...
const api = {
  ...
  setSecret:     (service: string, value: string, scope?: string, cloud?: boolean) => ipcRenderer.invoke('den:set-secret', service, value, scope, cloud),
  setSecretOp:   (service: string, ref: string, scope?: string, cloud?: boolean)   => ipcRenderer.invoke('den:set-secret-op', service, ref, scope, cloud),
  opAvailable:   ()                     => ipcRenderer.invoke('den:op-available'),
  removeSecret:  (service: string, scope?: string, cloud?: boolean) => ipcRenderer.invoke('den:remove-secret', service, scope, cloud),
  anthropicOAuth:()                     => ipcRenderer.invoke('den:anthropic-oauth'),
  oauthSecret:   (service: string, cloud?: boolean) => ipcRenderer.invoke('den:oauth-secret', service, cloud),
